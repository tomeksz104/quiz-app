<div class="my-5 col-span-2 flex justify-between">
    <button @if(!$steps[0]->isCurrent()) wire:click="previousStep" @endif class="transition-colors text-blue-500 fill-white bg-blue-100 hover:bg-blue-200 font-bold py-3 px-5 rounded-md inline-flex items-center {{ (!$steps[0]->isCurrent()) ?: 'cursor-not-allowed' }}">
    ...
    @if($steps[2]->isCurrent())
        <button wire:click="submit" class="transition-colors text-white fill-white bg-blue-500 hover:bg-blue-600 font-bold py-3 px-5 rounded-md inline-flex items-center">
            <span>Utwórz quiz</span>
            <svg class="ml-2" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 48 48" version="1.1"><path d="M14.7 35.9 3.5 24.7l2.15-2.15 9.05 9.05 2.15 2.15Zm8.5 0L12 24.7l2.15-2.15 9.05 9.05 19.2-19.2 2.15 2.15Zm0-8.5-2.15-2.15L33.9 12.4l2.15 2.15Z"/></svg>
        </button>
    @else
    <button wire:click="submit" class="transition-colors text-white fill-white bg-blue-500 hover:bg-blue-600 font-bold py-3 px-5 rounded-md inline-flex items-center">
